...
<div class="nk-app-root">
        ...
        <div class="nk-sidebar-brand">
            <a href="sangam.php" class="logo-link">
        <img class=" app-sidebar-logo-default" src="../images/logoooo.png"  height="80px">
        <div class="logo-wrap">
            </div></a>
    ...
    <div class="nk-sidebar-element nk-sidebar-body" style="margin-top:-25px">
        ...
        <ul class="nk-menu">
            ...
            <li class="nk-menu-item">
                <a href="replacement.php" class="nk-menu-link">
                    <span class="nk-menu-icon">
            <em class="icon ni ni-flag"></em></span>
            <span class="nk-menu-text">replacement_from</span></a></li>
            <!-- <li class="nk-menu-item">
                <a href="member.php" class="nk-menu-link">
                    <span class="nk-menu-icon">
            <em class="icon ni ni-users"></em></span>
            <span class="nk-menu-text">Members</span></a></li>
            <li class="nk-menu-item">
                <a href="news.php" class="nk-menu-link">
                    <span class="nk-menu-icon">
            <em class="icon ni ni-alert-fill"></em></span>
            <span class="nk-menu-text">News</span></a></li> -->
...
<div class="dropdown-content dropdown-content-x-lg py-3">
    <div class="dropdown-title pb-2"><h5 class="title">Recent searches</h5></div><ul class="dropdown-list gap gy-2"><li>
...
<div class="media-text">
    ...
    <span class="sub-text">1 days ago</span></div>
<div class="media-action media-action-end">
    <button class="btn btn-md btn-zoom btn-icon me-n1"><em class="icon ni ni-trash"></em></button></div></div></li><li>
    <div class="media-group">
    <div class="media media-sm media-middle media-circle text-bg-light"><em class="icon ni ni-clock"></em></div>
<div class="media-text">
    <div class="lead-text">Custom Select Input</div>
    <span class="sub-text">07 Aug</span></div>
<div class="media-action media-action-end">
    <button class="btn btn-md btn-zoom btn-icon me-n1"><em class="icon ni ni-trash"></em></button></div></div></li><li>
    <div class="media-group">
...
<li class="dropdown"><a href="#" data-bs-toggle="dropdown">
    <div class="d-sm-none">
    <div class="media media-sm media-circle"><img src="1.png" height="40px">></div></div>
<div class="d-none d-sm-block">
    <div class="media media-circle"><img src="1.png"  height="40px"></div></div></a>
<div class="dropdown-menu dropdown-menu-md">
    <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
    <div class="media-group">
    <div class="media media-xl media-middle media-circle"><img src="1.png"  height="40px"></div>
    
<div class="media-text">
    <div class="lead-text" style="text-transform:uppercase;color:red"><?=$_SESSION['user'];?></div>
    <span class="sub-text"></span></div></div></div>
<div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light"><ul class="link-list"><li><a href="view-admin.php"><em class="icon ni ni-user"></em> 
