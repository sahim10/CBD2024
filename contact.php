...
<head>
    ...
    <meta name="description"
        content="Crescent Blood Donors">
    <meta property="og:site_name" content="Crescent Blood Donors">
...
<body>
    <div class="main-page-wrapper">
		...
		============================================== 
		-->
        <div class="inner-banner-one pt-225 lg-pt-200 md-pt-150 pb-100 md-pb-70">
			
            <div class="container ">
			<div class="container text-center text-dark h1">Donor Registration</div>
                <div class="row align-items-center">
					
                    <div class="bg-wrapper light-bg mt-80 lg-mt-40 blue-form">
						
                        <div class="row">
				
                            <div class="col-lg-6">
                                <div class="form-style-one ps-xl-5">
                                    <form action="https://html.creativegigstf.com/babun/babun/inc/contact.php"
                                        id="contact-form" data-toggle="validator">
                                        ...
                                        <div class="row controls">
                                            ...
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
													...
													<input type="date" placeholder="Date of Birth*" name="dob" required="required" data-error="Valid date of birth is required.">
                                            ...
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
													...
													<br>
                                                    <input type="text" placeholder="Your Blood Group" name="name"
                                                        required="required" data-error="Name is required.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
                                                    ...
                                                    <input type="number" placeholder="Enter Weight" name="email"
                                                        required="required" data-error="Valid email is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row controls">
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-30">
                                                    ...
                                                    <input type="text" placeholder="Street Name" name="name"
                                                        required="required" data-error="Name is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
                                                    ...
                                                    <input type="text" placeholder="Enter Area" name="email"
                                                        required="required" data-error="Valid email is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
                                                    ...
                                                    <input type="email" placeholder="Enter City" name="email"
                                                        required="required" data-error="Valid email is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
                                                    ...
                                                    <input type="text" placeholder="Enter Pincode" name="email"
                                                        required="required" data-error="Valid email is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group-meta form-group mb-40">
                                                    ...
                                                    <input type="number" placeholder="Enter Mobile Number" name="email"
                                                        required="required" data-error="Valid email is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex text-center justify-content-center"><button class="btn-four tran3s text-center d-block">
                                  submit</button></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contact-us-section  lg-pt-80 bg-light">
            <div class="container">
				  
                <div class="position-relative">


                    <div class="bg-wrapper light-bg mt-80 ">
                        <div class="row">
                            <div class="col-lg-12">
                                   <h1 class="container text-center">Volunteer Form</h1>
                                ...
                                <div class="form-style-one ps-xl-5">
                                    <form action="https://html.creativegigstf.com/babun/babun/inc/contact.php"
                                        ...
                                        <div class="row controls">
                                            ...
                                            <div class="col-12"><button class="btn-four tran3s w-100 d-block">Submit</button></div>
                                        </div>
                                    </form>
                                </div> <!-- /.form-style-one -->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div
                                            ...
                                            <i class="fa fa-map-marker text-light h1 fs-1"></i></div>
                                ...
                                <div class="col-md-4">
                                    <div class="address-block-one text-center mb-40 wow fadeInUp">
                                        <div
                                            class="icon rounded-circle d-flex align-items-center justify-content-center m-auto">
                                            <i class="fa fa-phone text-light h1 fs-1"></i></div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div
                                            class="icon rounded-circle d-flex align-items-center justify-content-center m-auto">
                                            <i class="fa fa-question-circle text-light h1 fs-1" aria-hidden="true"></i></div>
                                        <h5 class="title">Live Support</h5>
                                        <p>live chat service <br><a href="#"
                                                class="webaddress">www.cbd.com</a></p>
                                    </div> <!-- /.address-block-one -->
                                </div>
                            </div>
                        </div>
